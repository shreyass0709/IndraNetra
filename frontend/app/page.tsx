        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto text-base">
              Traditional monitoring relies heavily on post-event analysis. Eye of Indra addresses this with active prevention.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-2xl font-extrabold text-slate-900 mb-6">Eye of Indra Solution</h3>
                <ul className="space-y-4">
                  {[
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="flex items-center gap-2">
              ...
              <strong className="text-sm font-extrabold text-slate-900 tracking-tight">Eye of Indra</strong>
            </div>
            <span>© 2026 Eye of Indra Framework. All rights reserved.</span>
          </div>
